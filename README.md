# Датчик температуры и владности для Apple Home

В этом репозитории вы найдете прошивку и схемы для датчика температуры и лажности с дисплеем, который может быть использолван с Apple Home. Видео про данный дачик можно посмотреть по [этой](https://youtu.be/CxgiTkTlNZg) ссылке.  
...
Если вам нравятся мои проекты и виде, вы можете пожжержать меня по ссылкам ниже:
